<style>
  #sidebar {
    ...
    /* CORRECCIÓN: Altura con box-sizing border-box */
    height: calc(100vh - 60px);
    overflow-y: auto;
    overflow-x: hidden;
    
    /* Agregar padding bottom para espacio extra */
    padding-bottom: 20px;
  }
  ...
  /* CORRECCIÓN: Espacio extra al final de la lista */
  .nav {
    padding-bottom: 10px;
  }

  /* CORRECCIÓN: Asegurar que el último elemento tenga margen inferior */
  .nav-item:last-child {
    margin-bottom: 10px;
  }
</style>
