...
Route::get('EstadoCuentaMesCliente','App\Http\Controllers\Cliente\RecoleccionController@EstadoCuentaMesCliente');
...
Route::get('ReporteRecolecciones/{FechaIni}/{FechaFin}/{Negocio}','App\Http\Controllers\Administracion\RecoleccionController@ReporteRecolecciones');
